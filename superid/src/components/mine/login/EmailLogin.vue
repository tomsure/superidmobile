...
<template>
  <div class="login-box" :style="backgroundDiv">
    ...
    <div class="t-center tc-w header-text">一站式区块链生态平台</div>
    <div class="login-box-common">
      <mt-field class="radius-top" placeholder="请输入电子邮箱" v-model="username"></mt-field>
    ...
    <div class="t-center bottom-text">
      <span @click="toMobileLogin">手机登录</span>
    </div>
